...
const Post = () => {
  ...
  // const checkFollowingStatus = (otherUserId) => {
  //   // Make an API call to check if the logged-in user is following the other user (otherUserId)
  //   axios
  //     .get(`${PORT}checkFollowingStatus/${userId}/${otherUserId}`)
  //     .then((response) => {
  ...
  useEffect(() => {
    if (userId) {
      ...
      //   checkFollowingStatus(getPostData[0].user_id);
      // }
    }
  }, [userId, addPost]);
  useEffect(() => {
  ...
  const handleFollowToggle = (userId) => {
    if (isFollowing) {
      // Unfollow logic for the user with userId

    } else {
      // Follow logic for the user with userId
      axios
        .post(`${PORT}addUserFollowPost/${userId}/${isAuth}`)
        .then(() => {
          setIsFollowing(true);
    ...
    <>
            ...
            <div className="col-lg-3 col-12 px-2">
              <div className="pofile_left_side_sections p-0">
                <div
                  ...
                  style={{
                    backgroundImage: `url(/upload/${getAlumniProfile && getAlumniProfile.cover_background
                                ...
                                <div className="d-flex justify-content-between p-2">
                                  <div className='d-flex'>
                                    <div className="post_right_profile_image2">
                                      <img
                                        src={`/upload/${post && post.profile_picture || "profileImage.png"}`}
                                        width="100%"
                                        alt="profile"
                                      />
                                    </div>
                                    <div>
                                      <p className="ms-1 mb-0 fw-bold fs-5">
                                        {post && post.username}
                                      </p>
                      ...
                      {getUserPostData.map((userPost, index) => {
                        return (
                          ...
                          >
                            ...
                            <div className="post_image mt-0 p-0">
                              <img
                                src={`/upload/${userPost && userPost.post_image
                                  }`}
                                width="100%"
                                alt="profile"
                              />
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form encType="multipart/form-data" method="post" onSubmit={addPostData}>
                <div className="mb-3">
                  <label htmlFor="alumniPostAddress" className="form-label fw-semibold">
                    Post Name:-
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="alumniPostImage" className="form-label fw-semibold">
                    Post Image:-
                  </label>
                  <input
                    type="file"
      ...
      <div className="modal fade" id="editPostModal" tabIndex="-1" aria-labelledby="editPostModalLabel" aria-hidden="true">
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title alumni_heading" id="editPostModalLabel">
            ...
            <div className="modal-body">
              <form>
                ...
                {editPostImage.post_image ? (
                  ...
                  <img
                    src={`/upload/${editPostImage.post_image ? editPostImage.post_image : "bgCover.jpeg"}`}
                    width="100px"
                    alt="default-post"
                    className="mt-2"
                  />
